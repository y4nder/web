...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    name: "Tatakforms Registration",
    component: () => import("../pages/tatakforms/TatakFormRegisterCollege.vue"),
  },
  {
    path: "/tatakforms/login",
    name: "Tatakforms Login",
...
router.beforeEach(async (to, _from, next) => {
  ...
  const isTatakformStudent = !!getStore("usat") && !!getStore("usrt");

  if (isTatakformStudent) {
    if (to.name === "Tatakforms Login") {
      return next({ name: "Tatakforms Home" });
    }
